...
# Buchwald SZ, Birgel D, Senger K, Mosociova T, Pei Y, Frank AB, Galasso F, Gómez Correa MA,
...
cor.test(all_ACHs$`C33-ACH`, mol$Pristane) # r = 0.9096739; p = 3.369e-12
cor.test(all_ACHs$`C33-ACH`, mol$Phytane) # r = 0.9029993; p = 8.761e-12
