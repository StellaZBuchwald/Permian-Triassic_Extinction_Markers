...
"Buchwald SZ, Birgel D, Senger K, Mosociova M, Pei Y, Zuchuat V, Tarhan LG, Frank AB, Galasso F,
Gómez Correa MA, Koşun E, Karapunar B, Wang X, Kustatscher E, Prinoth H, Lahajnar N, Steinkrauss R,
Peckmann J, & Foster WJ.
...
(2) The folder "area_nalk" contains one .txt-file per sample with the integrated peak areas of
n-alkanes prior to molecular sieve treatment with 5a-cholestane as co-injected standard.

(3) The Excel file "Extinction_Marker_Metadata.xlsx" contains the sheets
"meta_mol" with the metadata for the molecular sieve-treated samples, and the sheet
"meta_nalk" with the metadata for the samples prior ro molecular sieve treatment.
...
(4) The Excel file "MPI_raw.xlsx" contains the integrated peak areas of phenanthrene integrated from the
m/z = 178 mass chromatogram, and 1-, 2-, 3- and 9-methylphenanthrene integrated from the m/z = 192 mass
chromatogram.

(5) The Excel file "Extinction_Marker_Global_data.xlsx" contains qualitative supplementary information on the
